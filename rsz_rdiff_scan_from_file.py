...
parser.add_argument("-f", help="File containing addresses to check", required=True)
...
def process_address_file(file_path):
    with open(file_path, 'r') as file:
        addresses = file.readlines()

    for address in addresses:
        address = address.strip()
        print('\nStarting Program for Address:', address)
        print('-' * 120)
        ...
        # Time and RAM intensive process to make a bigger Table
...
process_address_file(file_path)
